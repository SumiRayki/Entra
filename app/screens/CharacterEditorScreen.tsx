                ...
                {characterCard && (
                    <KeyboardAwareScrollView
                        ...
                        <ThemedTextInput
                            ...
                            numberOfLines={2}
                            onChangeText={(mes) => {
                                setCharacterCardEdited({ ...characterCard, personality_traits: mes })
                            }}
                            ...
                            <>
                                ...
                                <View style={{ flexDirection: 'row', columnGap: spacing.m }}>
                                    <ThemedTextInput
                                        ...
                                        containerStyle={{ flex: 1 }}
                                        onChangeText={(mes) => {
                                            setCharacterCardEdited({ ...characterCard, nsfw_cup_size: mes })
                                        }}
                                    ...
                                    <ThemedTextInput
                                        ...
                                        containerStyle={{ flex: 1 }}
                                        onChangeText={(mes) => {
                                            setCharacterCardEdited({ ...characterCard, nsfw_hip: mes })
                                        }}
                                ...
                                <ThemedTextInput
                                    ...
                                    numberOfLines={2}
                                    onChangeText={(mes) => {
                                        setCharacterCardEdited({ ...characterCard, nsfw_sensitive_areas: mes })
                                    }}
                                ...
                                <ThemedTextInput
                                    ...
                                    containerStyle={styles.input}
                                    onChangeText={(mes) => {
                                        setCharacterCardEdited({ ...characterCard, nsfw_orientation: mes })
                                    }}

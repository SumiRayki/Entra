...
export enum AppSettings {
    ...
    AutoCompressContext = 'settings-auto-compress-context',
    ...
    ChatTopFade = 'settings-chat-top-fade',
}
...
export const AppSettingsDefault: Record<AppSettings, boolean> = {
    ...
    [AppSettings.AutoCompressContext]: true,
